...
- **UzayBank hesapları** — uygulamanın kendi veritabanında tutulur; kullanıcı farklı para birimlerinde hesap açabilir, para yatırıp çekebilir ve IBAN ile transfer yapabilir
...
| **Para birimi** | Bankadan geldiği gibi | TL, USD, EUR, GBP |
...
- 💱 **Çoklu para birimi** — TL, USD, EUR ve GBP cinsinden hesap açılabilir; her hesap kendi para birimi sembolüyle gösterilir
- 💸 **Para yatırma / çekme / transfer** — IBAN ile hesaplar arası transfer; yetersiz bakiye, geçersiz alıcı, aynı hesap ve para birimi uyuşmazlığı kontrolleri
...
| Para birimi doğrulaması | Farklı para birimindeki hesaplar arasında transfer engellenir |
...
| `POST` | `/api/uzayaccount` | Yeni hesap açar (para birimi seçimli, hesap no + IBAN otomatik) | ✅ |
...
- [x] Çoklu para birimi desteği (TL, USD, EUR, GBP)
...
- **Toplam bakiye yalnızca TL hesapları kapsar.** Kur dönüşümü uygulanmadığı için farklı para birimlerindeki bakiyeler tek bir toplamda birleştirilmemiştir.
